export function addDragEvent(task) {
...
export function createTaskElement({ value, renderDeleteBtn, renderEditBtn, }) {
...
export function insertAboveTask(column, mouseY) {
    const tasks = column.querySelectorAll(".task:not(.is-dragging)");
